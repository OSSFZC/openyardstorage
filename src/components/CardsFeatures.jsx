      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-center gap-8 mt-16">
          {features.map((item, index) => (
            <div
              key={index}
              className="w-full md:w-[calc(50%-2rem)] lg:w-[calc(33.333%-2rem)] group rounded-3xl bg-white border border-gray-200 p-8 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:border-[#C59D5F]"
            >
              {/* Icon */}
