...
export default function Navbar() {
  ...
  const projects = [
    {
      name: "Weatherford Drilling International",
  ...
  const locations = [
    {
      name: "Shipping Companies in Sharjah",
      slug: "shipping-companies-in-sharjah",
    },
    { name: "Hamriyah Port Sharjah", slug: "hamriyah-port-sharjah" },
    { name: "Cargo Service To Dubai", slug: "cargo-service-to-dubai" },
    {
      name: "Storage Facility In Sharjah",
      slug: "storage-facility-in-sharjah",
    },
  ];
          ...
          <nav className="flex flex-col gap-4 px-6 py-6 text-sm text-white">
            ...
            {aboutOpen && (
              <div className="ml-4 flex flex-col gap-3 text-white/80">
                <Link to="/about/our-story" onClick={() => setOpen(false)}>
                  Our Story
                </Link>
                <Link to="/about/founder" onClick={() => setOpen(false)}>
                  Founders
                </Link>
                <Link to="/about/vision-mission" onClick={() => setOpen(false)}>
                  Vision / Mission
                </Link>
                <Link to="/about/inspiration" onClick={() => setOpen(false)}>
                  Inspiration
                </Link>
              </div>
            )}
            ...
            {servicesOpen && (
              <div className="ml-4 flex flex-col gap-3 text-white/80">
                ...
                <Link to="/services/air-freight" onClick={() => setOpen(false)}>
                  Air Freight
                </Link>
                <Link to="/services/sea-freight" onClick={() => setOpen(false)}>
                  Sea Freight
                </Link>
                <Link
